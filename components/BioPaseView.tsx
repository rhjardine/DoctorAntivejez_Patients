      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 flex flex-col items-center">
          ...
          <div className="w-full max-w-sm flex flex-col gap-4">
              <button 
                ...
                disabled={isSyncing}
                className={`w-full py-5 rounded-2xl font-black uppercase text-sm tracking-widest flex items-center justify-center gap-3 shadow-lg transition-all active:scale-95 ${
                    isSyncing ? 'bg-gray-200 text-gray-500' : 'bg-primary text-white hover:bg-darkBlue'
                }`}
              >
