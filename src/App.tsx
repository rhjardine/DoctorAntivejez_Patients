...
const BiometricsView = React.lazy(() => import('./components/BiometricsView'));
...
const ClinicalInfoModal = React.lazy(() => import('./components/ClinicalInfoModal'));
        ...
        <AnimatePresence>
          {showTimeoutWarning && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 50 }}
              className="fixed bottom-32 left-4 right-4 z-[70] flex justify-center"
            >
              <div className="bg-white p-4 rounded-3xl shadow-2xl border-2 border-amber-100 flex items-center gap-4 max-w-sm w-full">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-bold text-darkBlue leading-tight">
                  ...
                  <button
                    ...
                    className="text-[10px] font-black uppercase text-primary mt-1 flex items-center gap-1"
                  >
                    <ShieldCheck size={12} /> Mantener sesión activa
                  </button>
                </div>
              </div>
            </motion.div>
