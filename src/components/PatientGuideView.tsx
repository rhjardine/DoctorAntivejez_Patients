  ...
  const renderItemCard = (item: PatientProtocol) => {
    ...
    return (
      ...
      >
        ...
        >
          <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all shadow-inner shrink-0 ${isCompleted
          ...
          <div className="flex-1 min-w-0">
            <h3 className={`font-black text-base leading-tight transition-all truncate ${isCompleted ? 'text-slate-400 line-through' : 'text-[#293B64]'
              }`}>
              {item.itemName}
            </h3>
            ...
            <div className="flex flex-col gap-1.5 mt-2.5">
              <div className="flex items-center gap-2">
                <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-tighter ${isCompleted ? 'bg-slate-100 text-slate-400' : 'bg-sky-50 text-primary'
                  }`}>
          ...
          {hasNotes && (
            <button
              ...
              className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all shrink-0 ${isNoteExpanded ? 'bg-primary text-white shadow-lg' : 'bg-slate-50 text-slate-300'
                }`}
            >
