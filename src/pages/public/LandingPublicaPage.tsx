                ...
                <motion.div variants={itemVariants} className="relative overflow-hidden bg-gradient-to-br from-[#293b64] to-[#14b8a6] rounded-[2.5rem] p-8 text-white shadow-2xl shadow-[#293b64]/20 text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h2 className="text-3xl font-black text-white leading-tight mb-3">
                            Descubre tu<br /><span className="text-cyan-100">Edad Biológica</span>
                        </h2>
                ...
                <motion.div variants={itemVariants} className="pt-4">
                    ...
                    <div className="grid gap-4">
                        ...
                        <button
                            ...
                            className="w-full bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-md shadow-slate-200/50 border border-slate-200 flex flex-col items-start gap-4 transition-transform active:scale-[0.98] hover:border-[#293b64] relative overflow-hidden group"
                        >
                            <div className="absolute right-0 top-0 h-full w-2 bg-[#293b64] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div className="flex items-center gap-4 w-full">
                                <div className="w-14 h-14 bg-slate-50 rounded-2xl flex items-center justify-center shrink-0">
